-- script made by ItsCapp, I just changed some stuff to make this work.

-- simply, offsets. they're the numbers in the top left of the character editor
idleoffsets = {'648', '480'} -- I recommend you have your idle offset at 0
leftoffsets = {'649', '481'}
downoffsets = {'646', '481'}
upoffsets = {'648', '479'}
rightoffsets = {'647', '481'}
...
name_of_character_xml = 'Faix'
name_of_character = 'Faix'
name_of_notetype = 'Faix'
...
function onCreate()
	...
	addAnimationByPrefix(name_of_character, 'idle', idle_xml_name, 15, false);
