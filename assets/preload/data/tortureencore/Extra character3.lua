...
idleoffsets = {'63', '121'} -- I recommend you have your idle offset at 0
leftoffsets = {'454', '-81'}
downoffsets = {'140', '10'}
upoffsets = {'122', '284'}
rightoffsets = {'40', '-53'}
...
name_of_character = 'eggman_soul'
name_of_notetype = 'Egg'
...
function onCreate()
	...
	addAnimationByPrefix(name_of_character, 'idle', idle_xml_name, 15, true);
