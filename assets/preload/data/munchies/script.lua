...
function onCreate()
	...
	makeLuaText('ARTIST1', 'Sir_Lies, Tri_Dot, Exipyx', 1000, 132, -1000) --Team Member Helping Name Here--
	setTextAlignment('ARTIST1', 'center')
	setTextSize('ARTIST1', 25)
	setObjectCamera('ARTIST1', 'other')
	addLuaText('ARTIST1')
	
	makeLuaText('MUSICIAN1', 'Wrath!', 1000, 132, -1000) --Team Member Helping Name Here--
